"use client";
import { DELETE_ARTICLE, GET_ALL_ADMINS, GET_ALL_ARTICLES, GET_ALL_PLAYLISTS } from "@queries";
...
export default function ListAdmins () {
    ...
    const columns = React.useMemo<ColumnDef<Admin>[]>(
        () => [
            ...
            //       return (
            //         <Text miw={180}>{translate("pages.admins.list.createdAt")}</Text>
            //       );
            //     },
            ...
            // },
            {
                ...
                header: function render() {
                    return (
                    <Text miw={150}>
                        {translate("pages.admins.list.title")}
                    </Text>
                    );
                },
                // cell: function render({ getValue }) {
            ...
            // },
            {
                ...
                cell: function render({ getValue }) {
                    ...
                    <Group spacing="xs" noWrap>
                        {/* <ShowButton hideText resource="admins" recordItemId={articleId} /> */}
                        <EditButton hideText resource="admins" recordItemId={articleId} />
                        {/* <DeleteButton  hideText resource="admins" recordItemId={articleId} /> */}
                    </Group>
                    );
                },
                enableColumnFilter: false,
    ...
    return (
        <List title={translate("pages.admins.titles.list")}>
            <ScrollArea>
