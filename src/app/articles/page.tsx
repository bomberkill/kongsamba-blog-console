"use client";
import { DELETE_ARTICLE, GET_ALL_ARTICLES } from "@queries";
...
export default function ListArticles () {
        ...
        () => [
            {
                ...
                header: function render() {
                  return (
                    <Text miw={180}>{translate("pages.articles.list.createdAt")}</Text>
                  );
                },
            ...
            {
                id: "title",
                accessorKey: "articleInput.title",
                header: function render() {
                    return (
                    <Text miw={250}>
                        {translate("pages.articles.list.title")}
                    </Text>
                    );
                },
                // cell: function render({ getValue }) {
            ...
            },
            {
                ...
                cell: function render({ getValue }) {
                    ...
                    <Group spacing="xs" noWrap>
                        <ShowButton hideText resource="articles" recordItemId={articleId} />
                        <EditButton hideText resource="articles" recordItemId={articleId} />
                        <DeleteButton  hideText resource="articles" recordItemId={articleId} />
                    </Group>
                    );
                },
                enableColumnFilter: false,
    ...
    return (
        <List title={translate("pages.articles.titles.list")}>
            <ScrollArea>
